...
public static class DebugActions
{
	...
	{
		GameComponent_MemeTracker.Instance.StartGasLighting(
	...
	private static void ToggleEclipse()
	{
		...
		{
			Find.World.GameConditionManager.ActiveConditions.Find(x =>
					x.def == GameConditionDefOf.Eclipse
				)
				.End();
		}
		else
		{
			IncidentParms incidentParms = new() { forced = true, target = Find.World };
